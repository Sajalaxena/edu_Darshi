    ...
    <section className="container mx-auto px-6 py-12">
      ...
      <div className="max-w-5xl mx-auto text-center">
        <h1
          ...
          style={{ color: "var(--brand, #334eea)" }}
        >
          Our Mentors
        </h1>
        <p className="mt-2 text-slate-600">
          Experienced mentors across academia & industry
        </p>
      </div>
      ...
      <div className="mt-8 max-w-5xl mx-auto">
        ...
        <div className="relative w-full mb-4">
          <input
            ...
            className="w-full rounded-xl bg-white/90 border border-slate-200 px-4 py-3 shadow-sm
        ...
        <div className="flex gap-2 overflow-x-auto no-scrollbar py-2">
          <button
            ...
            className={`px-4 py-2 whitespace-nowrap rounded-xl text-sm transition 
        ${
          !activeTag
      ...
      <div className="grid gap-6 mt-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {filtered.map((m) => (
          <div key={m.id} className="h-full">
            <MentorCard mentor={m} onOpen={(mentor) => setSelected(mentor)} />
          </div>
        ))}
      </div>
